				...
				<div className='px-6 pt-6 pb-4 flex flex-col'>
					...
					<div className='divide-y divide-white/6 overflow-hidden rounded-xl w-full h-fit bg-gradient-to-b from-[#1C1C1C] to-[#0D0D0D] mt-4'>
						<Line
							...
							title='Your node'
							description='The white dot is your Zcash node'
						/>
						<Line
							icon={<PeerDotIcon className='w-5 h-5 text-white' />}
							title='Your peers'
							description="Gold dots are other nodes you're connected to (peers). They appear bigger when multiple peers share the same location"
						/>
						<Line
